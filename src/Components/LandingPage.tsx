...
const TERMINAL_LINES: { prompt: string; cmd: string; out: string }[] = [
  ...
  { prompt: "~", cmd: "curl https://anishk.dev/hire-me",      out: "✓ 200 OK — let's talk" },
];
              ...
              >
                ...
                >
                  ...
                  <span className="text-[#ff375f]">
                    &quot;Hi, I&apos;m Anishk Khandelwal&quot;
                  </span>
                  <br />
                  <span className="text-[#00e5ff]/60">
                    &gt;&gt; MERN Stack Developer · Electron.js Architect
                  </span>
                  <br />
                  <span className="text-[#00e5ff]/40">
                    &gt;&gt; Offline-first specialist · ERP systems expert
                  </span>
                  <span
                ...
                <p className="text-white/50 text-base sm:text-lg leading-relaxed mb-8 max-w-lg">
                  Full-Stack Developer with production experience in MERN stack, Electron.js, and Node.js. 
                  Promoted to SDE-1 within 6 months for delivering 40% storage optimization and 99.9% uptime on enterprise ERP systems.
                </p>
              ...
              >
                ...
                >
                  <div className="relative rounded-[18px] overflow-hidden bg-[#090d13]">
                    <Image
                      src="/anishk.png"
                      alt="Anishk Khandelwal — Full-Stack Developer"
                      width={600}
                      height={800}
                      priority
                      ...
                      onError={(e) => {
                        (e.currentTarget as HTMLImageElement).src =
                          "https://placehold.co/600x800/090d13/00e5ff?text=Anishk+Khandelwal";
                      }}
                    />
                    {/* Bottom gradient */}
                    <div
