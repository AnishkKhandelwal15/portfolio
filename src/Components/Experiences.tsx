    ...
    positions: [
      {
        ...
        endDate: "Present",
        description:
          "Architected and optimized local database logic using PouchDB for high-volume data synchronization across 20+ instances. Implemented secure IPC channels between Electron main and renderer processes for efficient API and data handling. Designed advanced modules for project monitoring and material tracking within the ERP ecosystem. Improved performance for large-scale offline operations ensuring seamless online/offline mode transitions.",
        skills: [
          "Electron.js", "React.js", "Redux Toolkit", "Node.js", "Express.js",
          "PouchDB", "Worker Threads", "CryptoJS", "TypeScript", "JavaScript"
        ],
      },
      {
        ...
        description:
          "Built core offline-first architecture using PouchDB ensuring smooth local data management for 10,000+ records. Reduced storage footprint by 40% via AES-256 encryption with zlib compression; cut sync time from 30s to 5s. Engineered role-aware database partitioning across 10+ user roles with zero cross-role data leakage. Prevented data loss via automatic conflict detection with document merging, handling 500+ concurrent writes daily.",
        skills: [
          "Electron.js", "React.js", "Redux", "Node.js", "Express.js",
          "PouchDB", "Axios", "AES-256 Encryption", "TypeScript", "JavaScript"
        ],
      },
    ],
  },
