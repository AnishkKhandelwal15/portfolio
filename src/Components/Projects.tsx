...
const PROJECTS: Projects = {
  ...
  collaborative: [
    {
      title: "Construction ERP – Offline-First Desktop Application",
      description:
        "Led frontend and local database teams to deliver a fully offline-capable ERP for a construction company using Electron.js. Architected PouchDB-based local-first data layer with bidirectional sync engine ensuring zero data loss on reconnection. Delivered inventory, workforce, and project tracking modules actively used by 50+ employees across field sites.",
      tech: ["Electron.js", "React.js", "Redux Toolkit", "PouchDB", "Node.js", "Express.js", "CryptoJS"],
      role: "Full Stack Developer",
      date: "2025",
      featured: true,
    },
